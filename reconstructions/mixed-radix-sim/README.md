...
**Balanced Ternary** is a positional numeral system using base-3 with three digits (called **trits**):
...
1. **Radix Economy**: The theoretical optimum radix for representation efficiency is the mathematical constant $e \approx 2.718$. Three is closer to $e$ than two, meaning base-3 is mathematically more efficient than base-2 at representing numbers with a given number of states.
...
5. **Round-to-Nearest**: Truncating or rounding a balanced ternary number is identical to rounding to the nearest integer, avoiding the bias of truncating binary.
...
1. **Decimal-Ternary Converters**: Convert arbitrary decimal integers to balanced ternary strings and vice versa.
...
4. **Multi-Trit Ripple-Carry Adder**: Adds two arbitrary-length balanced ternary numbers, demonstrating that addition and subtraction share the identical hardware path.
5. **Multi-Trit Multiplier**: Implements Shift-and-Add multiplication for balanced ternary.
