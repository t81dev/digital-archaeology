...
|:---|:---|:---|
| **Spatial & Data-Parallel** | 1980s (Transputer, [Connection Machine](../excavations/connection-machine.md)) | AI Silicon (Systolic TPUs, Cerebras Wafer-Scale Engine, RDUs) |
| **Capability, Tagged & Descriptor** | 1970s–1980s (Burroughs, iAPX 432, [Lisp Machines](../excavations/lisp-machines.md)) | Hardware Security (CHERI memory bounds, Tagged architectures) |
...
- **1961**: Rolf Landauer derives the thermodynamic erasure limit ($E_{\text{min}} = k_B T \ln 2$), establishing the physical foundation for [reversible computing](../excavations/reversible-computing.md). **Key excavation link**: [Reversible Computing](../excavations/reversible-computing.md)
...
- **1967**: B.R. Gaines introduces [stochastic computing](../excavations/stochastic-computing.md), mapping continuous mathematical probabilities to random binary bitstreams to perform multiplication via a single 2-input AND gate. **Key excavation link**: [Stochastic Computing](../excavations/stochastic-computing.md)
