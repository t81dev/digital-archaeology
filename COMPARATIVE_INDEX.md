...
2. **The Spatial Data-Parallel Lineage**: *Systolic Arrays* $\rightarrow$ *Connection Machine* $\rightarrow$ *Dataflow Computing* $\rightarrow$ *Associative Processors* $\rightarrow$ *FPGAs / Modern AI accelerators (TPUs / PIM)*. This line bypasses the sequential program-counter paradigm to unlock massive spatial and in-memory throughput.
