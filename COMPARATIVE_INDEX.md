...
| **Virtual Machine / Language-Safe Sandbox** | Enforcing type-safety and isolation inside a managed runtime environment or interpreter instead of hardware. | - [Inferno](excavations/inferno.md) (Dis VM)<br>- [Smalltalk](excavations/smalltalk.md) ([Smalltalk](excavations/smalltalk.md) Image)<br>- [Lisp Machines](excavations/lisp-machines.md) (Lisp environment) |
...
| **Asynchronous Message Passing** | Dynamic, uncoordinated message queues at the operating system or runtime layer. | - [BeOS / Haiku](excavations/beos-haiku.md) (Ports)<br>- [Plan 9](excavations/plan-9.md) ([9P protocol](GLOSSARY.md))<br>- [Inferno](excavations/inferno.md) ([Styx protocol](GLOSSARY.md))<br>- [The MIT J-Machine](excavations/j-machine.md) ([Active Messages](GLOSSARY.md)) |
