...
1.  **Decoupled from Silicon Nodes**: The execution model is defined as an instruction set architecture (ISA) of a virtual register-and-[stack machine](../GLOSSARY.md), allowing software emulators to be compiled onto any general-purpose CPU.
