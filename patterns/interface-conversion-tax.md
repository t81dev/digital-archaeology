...
*   **[KeyKOS and the Nanokernel Capability Lineage](../excavations/keykos-nanokernel-capabilities.md)** — [KeyKOS](../GLOSSARY.md) provided microsecond-level IPC capability cross-overs on IBM mainframes. However, standard POSIX application assumptions of ambient authority and flat global filesystems introduced high translation layers, limiting capabilities to secure sandboxed niches.
