...
3.  **Resource containment requires explicit metering.** To prevent denial-of-service exploits in sandboxed environments, an explicit authority substrate must integrate resource metering (such as KeyKOS's Meter trees) as a first-class architectural primitive.
